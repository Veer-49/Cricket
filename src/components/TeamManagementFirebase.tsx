  ...
  const handleCreateTeam = async () => {
    ...
    try {
      const teamData = {
        ...
        updatedAt: new Date(), // Must be a Date object
        isPublic,
        wins: 0,
        losses: 0,
        draws: 0,
        shortCode: '', // Will be generated by FirebaseService
        joinUrl: '' // Will be generated by FirebaseService
      }
      ...
      if (newTeam) {
        ...
        // If team has a short code, show it to the user
        if (newTeam.shortCode) {
          ...
          if (navigator.clipboard) {
            ...
            toast.success(`Team Code: ${newTeam.shortCode}`)
          }
        }
      }
    } catch (error: any) {
